    ...
    <Container>
      <VStack spacing={4} as="article" my={10}>
        ...
        <Box as="form" onSubmit={(e) => e.preventDefault()}>
          <Input placeholder="Enter initial exponent" size="md" type="number" value={initialExponent} onChange={(e) => setInitialExponent(Number(e.target.value))} max="1000000000000000000" mr={2} />
